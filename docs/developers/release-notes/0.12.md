...
- channels now allow [much more configuration options](../../user-guide/01-channels.md#channel-specification)
- channels are now laid out in [a more natural way](../../user-guide/01-channels.md#default-location-on-your-system) in the user's config directory
...
Lots of new configuration options, all listed [here](../../reference/01-cli.md), among which:

- UI elements, sizes, layout (most of which are covered [here](../../reference/01-cli.md))
